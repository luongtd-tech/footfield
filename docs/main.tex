% This template is translated by LuongTD from K63 CNTTCLC - Vinh University
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\renewcommand{\baselinestretch}{1.6} % Line space 1.6
\setlength{\parskip}{12pt} % Spacing after paragraphs
...
\newpage
\pagenumbering{arabic} % Đánh số thứ tự 1,2,3... cho các chương nội dung
