...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{Figures/seq_vnpay.png}
    \caption[VNPay Payment Sequence]{Sequence Diagram: Secure VNPay Payment Handshake and IPN \mbox{Callback}}
    \label{fig:seq_vnpay}
\end{figure}
