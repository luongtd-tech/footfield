...
\begin{itemize}
    ...
    \item \textbf{Payment Gateway Exclusivity:} The system currently only integrates VNPay.
\end{itemize}

\subsection{Future Work}
To evolve FootField into a comprehensive enterprise solution, several future development paths have been identified:
\begin{itemize}
    \item \textbf{IoT Smart Lighting Integration:} Developing hardware relays connected to the booking database. This would allow the system to automatically turn on the football field floodlights exactly when a booked session begins.
    \item \textbf{Machine Learning Analytics:} Implementing predictive models to analyze historical booking data for dynamic pricing strategies.
\end{itemize}
